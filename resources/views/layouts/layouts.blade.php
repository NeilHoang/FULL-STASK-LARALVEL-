        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Welcome Blog Controller</h6>
                    <a class="collapse-item" href="{{route('user.create')}}">Create User</a>
                    <a class="collapse-item" href="{{route('user.list')}}">List User</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapseTwos" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Change Language</h6>
                    <a class="collapse-item" href="{{ route('user.change-language', 'en') }}">English</a>
                    <a class="collapse-item" href="{{ route('user.change-language', 'vi') }}">Viet Nam</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('cities.index')}}">Show City</a>
                    <a class="collapse-item" href="#">Create City</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('cities.index')}}" class="btn btn-secondary">List Cities</a>
                    <a href="{{route('customer.index')}}" class="btn btn-google">List Customer</a>
